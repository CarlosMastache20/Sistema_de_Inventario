...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <h4>Reporte de <?php echo $tipo_reporte?> año <?php echo $anio ?> Trimestre <?php echo $trimestre ?></h4>
        </div>
    </div>
</div>
<br>
<div class="container">
  <div class="row">
    <div class="col-lg-6">
      <label for="">Seleccione el año y trimestre para el reporte</label>
    ...
    <div class="col-lg-4">
    <?php
    SumaT_C_V($anio,$id_sucursal,$trimestre);
    ?>
    </div>
  </div>
</div>
      ...
      <div class="col-lg-12">
        <table id="example" class="table table-bordered  display nowrap" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            reportes_SUB_Trimestral($anio,$id_sucursal,$trimestre);
            ?>
            </tbody>
            <tfoot class="thead">
            <tr>
