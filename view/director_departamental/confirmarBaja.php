...
<?php
include ('../../controller/baja_alta/confirmarBaja.php');
?>
<div class="container">
  <div class="row">
      <?php
      msg_codigoBaja($id_sucursal);
      ?>
  </div>
  <br>
    <div class="row">
...
<!--Tabla-->
        <table id="example" class="table table-bordered  display nowrap" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            <tfoot class="thead">
            <tr>
              <th class="tr_op3">Codigo de Baja</th>
              <th>Confirmar</th>
            </tr>
            </tfoot>
        </table>  
    ...
    <div class="row">
      ...
      <?php
        if($_SERVER["REQUEST_METHOD"] == "POST") {
          confirmar_codigo_actualizar_Baja($_POST["codigo"],$_POST['id_sucursal']);
      }
      ?>
      </div>
    </div>
