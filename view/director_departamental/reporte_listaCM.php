...
<nav class="navbar navbar-info bg-info">
    <div class="container-fluid">
        <a class="navbar-brand" href="reportes.html" style="text-decoration: none !important; color: white !important; font-weight: bold !important;">
            Inicio</a>
    </div>
</nav>
<br>
...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <h4>Reporte de <?php echo $tipo_reporte?> año <?php echo $anio ?> Mes <?php echo $mes .' '.$categoria?></h4>
        </div>
    </div>
</div>
<br>
<div class="container">
  <div class="row">
    <div class="col-lg-6">
      <label for="">Seleccione el año, mes y categoria para el reporte</label>
    ...
    <div class="col-lg-4">
    <?php
    SumaMCa_C_V($anio,$id_sucursal,$mes,$categoria);
    ?>
    </div>
  </div>
</div>
      ...
      <div class="col-lg-12">
        <table id="example" class="table table-bordered  display nowrap" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            reportesCa_SUB_Mensual($anio,$id_sucursal,$mes,$categoria);
            ?>
            </tbody>
            <tfoot class="thead">
            <tr>
              <th class="tr_op3">Producto</th>
