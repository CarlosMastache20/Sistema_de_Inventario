...
<?php
include ('../../controller/prestamo/solicitudes.php');
?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="alert alert-warning" role="alert">
                    ...
                    ?> solicitudes -->
                    Aqui aparecen tus solicitudes para prestar
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <table id="example" class="table table-bordered  display nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <?php
                        inventario_S($id_sucursal);
                        ?>
                    </tbody>
                    <tfoot class="thead text-center">
                        <tr>
                            <th class="tr_op3">Tienda Solicitante</th>
