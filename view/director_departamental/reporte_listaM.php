...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <h4>Reporte de <?php echo $tipo_reporte?> año <?php echo $anio ?> Mes <?php echo $mes ?></h4>
        </div>
    </div>
</div>
<br>
<div class="container">
  <div class="row">
    <div class="col-lg-6">
      <label for="">Seleccione el año y mes para el reporte</label>
    ...
    <div class="col-lg-4">
    <?php
    SumaM_C_V($anio,$id_sucursal,$mes);
    ?>
    </div>
  </div>
</div>
      ...
      <div class="col-lg-12">
        <table id="example" class="table table-bordered  display nowrap" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            reportes_SUB_Mensual($anio,$id_sucursal,$mes);
            ?>
            </tbody>
            <tfoot class="thead">
            <tr>
