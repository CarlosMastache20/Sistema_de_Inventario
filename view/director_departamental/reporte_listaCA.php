...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <h4>Reporte de <?php echo $tipo_reporte?> año <?php echo $anio .' '.$categoria?> </h4>
        </div>
    </div>
</div>
<br>
<div class="container">
  <div class="row">
    <div class="col-lg-6">
      <label for="">Seleccione el año para el reporte y categoria</label>
    ...
    <div class="col-lg-4">
    <?php
    SumaCa_C_V($anio,$id_sucursal,$categoria);
    ?>
    </div>
  </div>
</div>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        <table id="example" class="table table-bordered  display nowrap" cellspacing="0" width="100%">
          ...
          <tbody>
            <?php
            reportesCa_SUB_Anual($anio,$id_sucursal,$categoria);
            ?>
            </tbody>
            <tfoot class="thead">
            <tr>
