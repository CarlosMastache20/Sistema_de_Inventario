...
<div class="container">
  <div class="row">
    ...
    <h5 class="title1I">Inventario</h5>
    <h6>Seleccione que departamento desea ver</h6>
    </div>
  </div>
</div>
<br><br>
  ...
  <div class="row">
    ...
    <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
      <select name="id_S" id="">
        ...
        <option value="3">Simbolos Patrios</option>
        <option value="4">Xoxocotlan</option>
        <option value="5">Zimatlan</option>
          ...
          <tbody>
            <?php
             if($_SERVER["REQUEST_METHOD"] == "POST") {
                inventario_departamento_General($_POST['id_S']);
             }
            ?>
            </tbody>
            <tfoot class="thead">
