    ...
    <div class="container">
        <div class="row">
            <div class="col lg-12" style="text-align: center;">
                <h1 class="title1">Director General</h1>
            </div>
        </div>
            ...
            <div class="col-lg-4">
                <div class="card text-center card1P">
                    <div class="card-body">
                        ...
                        <br>
                            <a href="prestamo.php"><button type="button" name="" id="" class="btn btn-warning">Préstamo</button></a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="card text-center card1P">
                    <div class="card-body">
                        ...
                        <br>
                            <a href="reportes.php"><button type="button" name="" id="" class="btn btn-warning">Reportes</button></a>
                        </p>
                    </div>
                </div>
            </div>
