                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <form action="reportes2.php" method="post">
                                    <input hidden type="text" name="id_sucursal" id="" value="2">
                                <button type="submit" class="btn btn-warning">Reforma</button>
                                </form>
                            </div>
                            <div class="col-lg-4">
                                <form action="reportes2.php" method="post">
                                    <input hidden type="text" name="id_sucursal" id="" value="4">
                                <button type="submit" class="btn btn-warning">Xoxocotlan</button>
                                </form>
                            </div>
                            <div class="col-lg-4">
                                <form action="reportes2.php" method="post">
                                    <input hidden type="text" name="id_sucursal" id="" value="1">
                                <button type="submit" class="btn btn-warning">Matriz</button>
                                </form>
                            </div>
                        </div>
                        <br><br>
                        <div class="row">
                            <div class="col-lg-6">
                                <form action="reportes2.php" method="post">
                                    <input hidden type="text" name="id_sucursal" id="" value="5">
                                <button type="submit" class="btn btn-warning">Zimatlan</button>
                                </form>
                            </div>
                            <div class="col-lg-6">
                                <form action="reportes2.php" method="post">
                                    <input hidden type="text" name="id_sucursal" id="" value="3">
                                <button type="submit" class="btn btn-warning">Simbolos Patrios</button>
                                </form>
                            </div>
                        </div>
                        <br>
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <form action="reporte_listaGT.php" method="post">
                            ...
                            <div class="col-lg-4">
                                <form action="reporte_listaGM.php" method="post">
